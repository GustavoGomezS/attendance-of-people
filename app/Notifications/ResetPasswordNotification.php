...
class ResetPasswordNotification extends Notification
{
  ...
  public function toMail($notifiable)
  {
      ...
      ->line(Lang::get('Se ha Solicitado un restablecimiento de contraseña para tu cuenta ' . $notifiable->getEmailForPasswordReset() . ', haz clic en el botón que aparece a continuación para cambiar tu contraseña.'))
