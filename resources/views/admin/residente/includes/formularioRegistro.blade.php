...
<div class="row">
  ...
  <div class="col-lg-3">
    {{-- campo estado --}}
    <div class="form-group">
      <label for="estadoResidente" class="col-lg-12 control-label ">Estado</label>
      <select class="form-control " id="estadoResidente" name="estadoResidente" >
        <option value="" disabled selected>Seleccion...</option>
