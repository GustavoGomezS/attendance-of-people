      ...
      <tr>   
        <td>
          <div class="image-container">
            <img class="image-zoom" height="100" width="100" src="{{ asset($item->fotoResidente) }}" alt="foto residente" data-zoom="{{ asset($item->fotoResidente) }}">
            ...
            <div class="form-group">
              <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                <input type="checkbox" class="custom-control-input estadoResidente" name="estadoResidente"
                  ...
                  @if($item->estadoResidente == "3"){{"checked"}}@endif
                >
