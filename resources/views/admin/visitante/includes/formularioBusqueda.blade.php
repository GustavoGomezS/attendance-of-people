    ...
    <div class="row  col-lg-12">
        <div class="form-group col-lg-4">
            ...
            <select name="filtro" id="filtro" class="form-control col-lg-9">
                ...
                <option value="documentoVisitante">Documento</option>
                <option value="telefonoVisitante">Telefono</option>
                <option value="nombreVisitante">Nombre</option>
            </select>
        </div>
        <div class="form-group col-lg-6">
            <label for="buscar" class="control-label col-lg-3">Buscar</label>
            <input type="text" value="" name="buscar" id="buscar" class="form-control col-lg-9" placeholder="Buscar Visitante">
        </div> 
    </div>       
</form>
